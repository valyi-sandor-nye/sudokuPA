...
import static hu.nye.progtech.sudoku.model.Constants.*;
...
public class ConsoleGameController implements GameController {
    ...
    private void processInput(String[] parts) {
        ...
        try {
            ...
            System.out.println(e.getMessage()); // LOGGER.error("Nem siker
    ...
    private boolean verifyInput(String[] parts) {
        try {
            ...
            System.out.println("You should give an integer number value!");
            return false;
        }
